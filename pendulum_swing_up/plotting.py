...
def episodic_cost_vs_uncertainty(source_domain, source_task, target_domain):
    ...
    all_task_names = ['Task 0', 'Task 1', 'Task 2', 'Task 3', 'Task 4', 'Task 5', 'Task 6']
    #all_costs = []
    #all_deviations = []
    ...
    plt.xlabel('Episodic Rewards', fontweight='bold')
    plt.ylabel('Standard Deviations', fontweight='bold')
    plt.title('Trained on Task 6', fontsize=18)
    plt.legend()
    plt.show()