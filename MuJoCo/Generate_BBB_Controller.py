...
if __name__ == '__main__':
    ...
    generate_BBB_controller(domain_name=args.domain, task_identity=args.task, window_size=args.window_size, number_demonstrations=args.number_demonstrations, epochs = 10001, number_mini_batches = 20,
