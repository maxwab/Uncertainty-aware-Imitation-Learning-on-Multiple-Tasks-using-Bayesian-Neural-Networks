...
def generate_GP_controller(domain_name, task_identity, window_size, number_demonstrations):
    ...
    file_to_save_gp_fit_logs = LOGS_DIRECTORY + domain_name + '_' + str(task_identity) + '_' + str(window_size) + '_GP_fit.pkl'
    gp_fit_logs = {}
    ...
    validate_GP_controller(domain_name=domain_name, task_identity=task_identity, window_size=window_size, drift_per_time_step=drift_per_time_step, moving_windows_x_size=moving_windows_x_size, behavior_controller=m,
